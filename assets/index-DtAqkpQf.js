(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={name:`Gomu Gomu`,oneLiner:`I just try stuff. Some of it works.`,subLine:`Computer Science Grad · Carleton University`,location:`Ottawa, ON, Canada`,email:`kelvinrein.ca@outlook.com`,linkedin:`https://www.linkedin.com/in/khunthurein77ca/`,github:`https://github.com/KelvinRein7`,resume:`/KelvinRein-Resume.pdf`,year:new Date().getFullYear()},t={displayName:`Kelvin Rein`,verticalName:`Data x Web x AI/ML`,portrait:null,portraitAlt:`Kelvin Rein persona`},n={heading:`About`,paragraphs:[`I've been learning through building — from cleaning messy datasets and creating dashboards to shipping websites and teaching Python to hundreds of students.`,`Today, I use AI as a force multiplier to learn faster, prototype ideas, debug problems, and turn concepts into working products.`,`Each project, success or failure, teaches me something new about building better.`]},r={degree:`Bachelor of Computer Science`,school:`Carleton University`,dates:`June 2026`,location:`Ottawa, ON`},i=[{id:`studysuccess`,role:`Data Analytics Specialist`,org:`StudySuccess.org`,dates:`Jan 2025 – Dec 2025`,location:`Remote`,story:`I took scattered student and applicant data from multiple sources and made it trustworthy — then made it useful. I built the Power BI dashboards and automated reporting the team relied on to track applications, outcomes, and program performance, plus cohort and funnel analysis that actually drove decisions.`,tags:[`Python`,`SQL`,`Power BI`,`ETL`],photos:[],link:null},{id:`fcac`,role:`Data Analyst / Data Scientist Intern`,org:`Financial Consumer Agency of Canada`,dates:`Sep 2023 – May 2024`,location:`Ottawa`,story:`I worked with 10,000+ real consumer complaint records for a federal agency. I built and evaluated NLP models to automatically classify complaints, and automated ETL pipelines that cut manual processing by ~30%. My first taste of ML with real-world stakes — government data, real consumers.`,tags:[`Python`,`SQL`,`NLP`,`ETL`],photos:[`/experience/fcac.png`],link:null},{id:`bladex`,role:`Head of Technology & Analytics`,org:`BladeX Education`,dates:`Ongoing · side`,location:null,story:`I'm the entire tech department. I maintain and evolve the company's website and database single-handedly — infrastructure, content, data, all of it. When something breaks at BladeX, I'm the one who fixes it; when something new is needed, I'm the one who builds it.`,tags:[`Web`,`Database`,`Analytics`],photos:[`/experience/bladex.png`],link:`https://bladex-edu.vercel.app/Home`,linkLabel:`Website`},{id:`win`,role:`Freelance Web Developer`,org:`WIN International Education`,dates:`Ongoing · freelance`,location:null,story:`Hired to build their website from the ground up as an independent freelancer. Client work: translating what a business needs into something real on the internet, on my own schedule, with my own judgment.`,tags:[`Web`,`Freelance`],photos:[],link:null,hidden:!0},{id:`ta`,role:`Teaching Assistant (Python)`,org:`Carleton University`,dates:`Jan 2023 – Dec 2024`,location:null,story:`I graded 500+ assignments, but the real job was feedback — helping students actually get better at Python, not just get grades. I hosted tutorials too.`,tags:[`Python`,`Teaching`],photos:[],link:null}],a=[{id:`housing`,title:`Canadian Housing Prices: Booms, Corrections & Regional Divergence`,status:`live`,story:`34,026 Statistics Canada records, 27 metro areas, one question — what actually happened to Canadian housing? I used window functions and statistical aggregations to find the booms and corrections, then interactive Tableau visuals to explain COVID-era acceleration and why regions diverged.`,tech:[`Python`,`SQL (BigQuery)`,`Tableau`],link:`https://khunmainportfolio.notion.site/Canadian-Housing-Prices-Booms-Corrections-Regional-Divergence-34594b47cb7d80c2a5f9d9193e498c8b`,linkLabel:`Project Link`,photos:[`/projects/housing.png`],featured:!0},{id:`exp-1`,title:`Tuduist`,status:`experiment`,story:`The simplest productivity app you can find on App Store — tasks, focus, and the usual “will I actually use this?” experiment. I actually use it daily :D`,tech:[`iOS`,`Swift`],link:`https://apps.apple.com/ca/app/tuduist/id6782297759`,linkLabel:`App Store`,photos:[],logo:`/projects/tudu-logo.png`,featured:!1},{id:`exp-2`,title:`Untitled experiment`,status:`experiment`,story:`Another slot for whatever I decide to build next.`,tech:[],link:null,linkLabel:null,photos:[],featured:!1}],o=[{id:`carleton-ai`,role:`Web Developer`,org:`Carleton AI Society`,dates:`~1 year`,story:`I kept the web presence running for Carleton's AI club — the place where the AI-curious on campus found talks, events, and each other. Community work, not a job: lighter stakes, genuine fun.`,tags:[`Web`,`Community`]}],s={heading:`Beyond the Code`,framing:`When I'm not in a Jupyter notebook: on a pitch, at a table, on a plane, or catching up on One Piece.`,items:[{id:`soccer`,title:`Soccer`,blurb:`I play it and I watch it. Lifestyle, not a hobby. (Also: I own drafthacker.com and think a lot about fantasy football data.)`},{id:`onepiece`,title:`One Piece`,blurb:`Long-time anime fan. If you spot a quiet easter egg somewhere on this site, that's on purpose.`},{id:`food`,title:`Food`,blurb:`Eating it, hunting for it, traveling for it.`},{id:`travel`,title:`Travel`,blurb:`New places, new food — ideally both at once.`}]},c={heading:`Contact`,cta:`Open to data, web, and AI/ML opportunities — let's talk.`};function l(e){return String(e).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`)}function u(e){return e?.length?`<ul class="tech-list">${e.map(e=>`<li>${l(e)}</li>`).join(``)}</ul>`:``}function d(e,t,n=2){let r=[...e||[]];if(!r.length&&n<=0)return``;for(;r.length<n;)r.push(null);return`
  ...
  `}function m(){if(t.portrait){let e=l(t.portrait),n=l(t.portraitAlt);return`
      <picture>
        <source srcset="${e.replace(/\.(png|jpe?g|gif)$/i,`.webp`)}" type="image/webp" />
        <img
    ...
    <span class="luffy-peek" tabindex="0">
      ...
      <span class="peek-label">${l(t.displayName)}</span>
    </span>
  `}function g(){let n=m(),r=n?`
      ...
      `:``;return`
    <section class="hero ${n?``:`hero--no-portrait`}" id="top">
      <div class="hero__inner">
        ...
        <div class="hero__copy">
          ...
          ${n?``:`<p class="hero__location hero__location--inline reveal" data-reveal>${l(e.location)}</p>`}
            ...
            <li class="hero__mail">
              ...
              >
                ...
                <form class="mail-win__body" id="mail-form" novalidate>
                  <p class="mail-win__to">To: ${l(e.email)}</p>
  ...
  `}function _(){let e=n.paragraphs.map(e=>`<p class="about__body-p">${l(e)}</p>`).join(``);return`
  ...
  `}function v(){return`
    <section class="section experience" id="experience">
      <div class="section__inner">
        ...
        <div class="exp-list">${i.filter(e=>!e.hidden).map((e,t)=>{let n=d(e.photos,e.org,0);return`
      <article class="exp-item${n?` exp-item--media`:``} reveal" data-reveal>
  ...
  `}function y(){let e=a.filter(e=>e.status===`live`),t=a.filter(e=>e.status===`experiment`);return`
    <section class="section work" id="projects">
      <div class="section__inner">
        ...
        <div class="project-list">${e.map(e=>{let t=e.link&&e.linkLabel?` <a class="project__title-link" href="${l(e.link)}" target="_blank" rel="noopener">(${l(e.linkLabel)})</a>`:``,n=d(e.photos,e.title,+!!e.photos?.length);return`
        <article class="project${n?` project--media`:``} ${e.featured?`project--featured`:``} reveal" data-reveal>
      ...
      `}).join(``)}</div>
        <div class="experiments">
          ...
          <div class="project-list project-list--experiments">${t.map(e=>{let t=e.link&&e.linkLabel?` <a class="project__title-link project__title-link--ink" href="${l(e.link)}" target="_blank" rel="noopener">(${l(e.linkLabel)})</a>`:``,n=d(e.photos,e.title,+!!e.photos?.length),r=e.logo?`<div class="project__corner">
              <img class="project__corner-logo" src="${l(e.logo)}" alt="" aria-hidden="true" />
            </div>`:``;return`
      <article class="project project--experiment${n?` project--media`:``}${e.logo?` project--logo`:``} reveal" data-reveal>
        <div class="project__text">
          <div class="project__top">
            <h3>${l(e.title)}${t}</h3>
